...
function Cv(props) {
    ...
    useEffect( () => {
        document.title = 'Votre cv';
        const response =  axiosInstance.get('/cv');
    ...
    const save = async (e) => {
        ...
        try {
            ...
            if (response.status===201){
                const cv_id = response.data.id;
                alert(cv_id)

                // Stocker l'UUID dans les cookies
                Cookies.set('cv_id', cv_id);
            ...
            <div className="cvform">
                <form>
                    ...
                    <div className="information-container">
                        ...
                        <div className="information-container-input">
